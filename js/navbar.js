...
a_news.setAttribute("href", path_suffix + "news/index.html");
a_news.appendChild(document.createTextNode("News"));
news.appendChild(a_news);
...
switch(body.id) {
    ...
    case "contact-page":
        ...
        break;
    case "news-page":
        news.setAttribute("class", "entry_active");
        break;
    case "photos-page":
